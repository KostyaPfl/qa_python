...
class TestBooksCollector:
    ...
    def test_add_new_book_book_added_without_genre(self, collector, books_genre):
    ...
    def test_add_new_book_duplicate_book_not_added(self, collector, books_genre):
        collector.add_new_book('Гордость и предубеждение и зомби')
        assert len(collector.get_books_genre()) == 1

    @pytest.mark.parametrize('genre', ['Фантастика', 'Ужасы', 'Детективы', 'Мультфильмы', 'Комедии'])
    def test_set_book_genre_existing_genre_added(self, collector, books_genre, genre):
    ...
    def test_set_book_genre_not_existing_genre_not_added(self, collector, books_genre):
    ...
    def test_get_book_genre_genre_for_existing_book(self, collector, books_genre):
        collector.set_book_genre('Гордость и предубеждение и зомби', 'Ужасы')
    ...
    @pytest.mark.parametrize('genre', ['Фантастика', 'Ужасы', 'Детективы', 'Мультфильмы', 'Комедии'])
    def test_get_books_with_specific_genre_get_books_for_existing_in_books_genre(self, collector, books_genre, genre):
        collector.set_book_genre('Гордость и предубеждение и зомби', genre)
        assert collector.get_books_with_specific_genre(genre) == ['Гордость и предубеждение и зомби']

    def test_get_books_with_specific_genre_get_books_for_not_existing_in_books_genre(self, collector, books_genre):
        collector.set_book_genre('Гордость и предубеждение и зомби', 'Ужасы')
        assert collector.get_books_with_specific_genre('Мюзикл') == []

    @pytest.mark.parametrize('age_rating', ['Ужасы', 'Детективы'])
    def test_get_books_for_children_no_book_with_age_rating(self, collector, books_genre, age_rating):
    ...
    def test_get_books_for_children_get_book_without_age_rating(self, collector, books_genre, age_rating):
        collector.set_book_genre('Гордость и предубеждение и зомби', age_rating)
        assert collector.get_books_for_children() == ['Гордость и предубеждение и зомби']

    def test_add_book_in_favorites_existing_book_added(self, collector, books_genre):
    ...
    def test_add_book_in_favorites_duplicate_book_not_added(self, collector, books_genre):
        collector.add_book_in_favorites('Гордость и предубеждение и зомби')
        collector.add_book_in_favorites('Гордость и предубеждение и зомби')
    ...
    def test_delete_book_from_favorites_not_existing_book_not_delete(self, collector, books_genre):
        collector.add_book_in_favorites('Гордость и предубеждение и зомби')
